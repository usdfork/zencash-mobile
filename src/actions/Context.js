...
export const SET_BZC_IN_BTC_VALUE = 'SET_BZC_IN_BTC_VALUE'
export const SET_BZC_IN_CURRENCY_VALUE = 'SET_BZC_IN_CURRENCY_VALUE'

export function setZenInBtcValue (BTCValue) {
  return {
    type: SET_BZC_IN_BTC_VALUE,
    BTCValue
  }
}
...
export function setZenInCurrencyValue (currencyValue) {
  return {
    type: SET_BZC_IN_CURRENCY_VALUE,
    currencyValue
  }
}
